var alien,alienimg,cloud,cloudimg,cloudg,ground,bcloud,bcloudimg,bcloudg,taco,pizza,sushi,sandwich,hotdog,score,food,rand,reset,reset1,hscore,ground1,groundimg
...
hotdog=loadImage("hotdog.png");
  groundimg=loadImage("land-1.jpg");
}
